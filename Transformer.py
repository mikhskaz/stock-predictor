...
hist_stocks = ['MSFT', 'NVDA', 'AAPL', 'AMZN', 'GOOG', 'META']
...
for ticker in hist_stocks:
    ...
    ticker_df = pd.DataFrame({
        ticker + '_close': close.squeeze(),  # Ensure 1D
    ...
    }, index=data.index)  # Use the index from the original data
